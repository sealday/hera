...
import { COMPENSATION_PLAN, queryPricePlan, newSuccessNotify, newInfoNotify, newErrorNotify  } from '../../actions'

const CompensationForm = reduxForm({ form: 'COMPENSATION_EDIT', action: 'edit' })(Form)

class CompensationEdit extends React.Component {
  componentDidMount() {
    if (!this.props.plan) {
...
export default connect(mapStateToProps)(CompensationEdit)
